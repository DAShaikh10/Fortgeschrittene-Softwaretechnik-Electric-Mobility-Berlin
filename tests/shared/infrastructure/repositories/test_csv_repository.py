...
class TestCSVRepositoryInitialization:
    ...
    def test_initializes_with_file_path(self, sample_file_path):
        """Test that repository initializes without errors."""
    ...
    def test_initializes_with_different_file_paths(self):
        ...
        assert isinstance(repo1, CSVRepository)
        assert isinstance(repo2, CSVRepository)
        assert isinstance(repo3, CSVRepository)
    ...
    def test_can_instantiate_directly(self, sample_dataframe):
        ...
        with patch("pandas.read_csv") as mock_read_csv:
            ...
            assert isinstance(repo, CSVRepository)
            # Verify pandas was called (behavior verification)
            # Note: _load_csv is called in __init__ automatically
...
class TestLoadCSV:
    ...
    def test_load_csv_calls_pandas_read_csv(self, mock_read_csv, sample_file_path, sample_dataframe):
        """Test that _load_csv calls pandas.read_csv with correct file path."""
        mock_read_csv.return_value = sample_dataframe
        repo = ConcreteCSVRepository(sample_file_path)

        result = repo.load_csv(sep=",")

        mock_read_csv.assert_called_once_with(sample_file_path, sep=",")
        pd.testing.assert_frame_equal(result, sample_dataframe)

    @patch("pandas.read_csv")
    def test_load_csv_with_comma_separator(self, mock_read_csv, sample_file_path, sample_dataframe):
    ...
    @patch("pandas.read_csv")
    def test_load_csv_with_semicolon_separator(self, mock_read_csv, sample_file_path, sample_dataframe):
    ...
    @patch("pandas.read_csv")
    def test_load_csv_with_tab_separator(self, mock_read_csv, sample_file_path, sample_dataframe):
    ...
    @patch("pandas.read_csv")
    def test_load_csv_passes_additional_kwargs(self, mock_read_csv, sample_file_path, sample_dataframe):
        """Test that _load_csv passes additional kwargs to pandas.read_csv."""
        mock_read_csv.return_value = sample_dataframe
        repo = ConcreteCSVRepository(sample_file_path)

        result = repo.load_csv(sep=",", encoding="utf-8", skiprows=1)
    ...
    @patch("pandas.read_csv")
    def test_load_csv_with_multiple_additional_kwargs(self, mock_read_csv, sample_file_path, sample_dataframe):
        """Test that _load_csv handles multiple additional kwargs."""
        mock_read_csv.return_value = sample_dataframe
        repo = ConcreteCSVRepository(sample_file_path)

        result = repo.load_csv(sep=",", encoding="latin-1", header=0, index_col=0, na_values=["N/A", "NULL"])
    ...
    @patch("pandas.read_csv")
    def test_load_csv_returns_dataframe(self, mock_read_csv, sample_file_path, sample_dataframe):
    ...
    @patch("pandas.read_csv")
    def test_load_csv_with_empty_dataframe(self, mock_read_csv, sample_file_path):
    ...
    @patch("pandas.read_csv")
    def test_load_csv_called_multiple_times(self, mock_read_csv, sample_file_path, sample_dataframe):
        """Test that _load_csv can be called multiple times."""
        mock_read_csv.return_value = sample_dataframe
        repo = ConcreteCSVRepository(sample_file_path)

        result1 = repo.load_csv(sep=",")
        result2 = repo.load_csv(sep=";")
    ...
    @patch("pandas.read_csv")
    def test_load_csv_preserves_file_path(self, mock_read_csv, sample_file_path, sample_dataframe):
    ...
    @patch("pandas.read_csv")
    def test_load_csv_with_no_additional_kwargs(self, mock_read_csv, sample_file_path, sample_dataframe):
...
class TestCSVRepositoryIntegration:
    ...
    @patch("pandas.read_csv")
    def test_complete_workflow(self, mock_read_csv, sample_file_path, sample_dataframe):
        ...
        # Load CSV
        result = repo.load_csv(sep=",", encoding="utf-8")
    ...
    @patch("pandas.read_csv")
    def test_multiple_repositories_with_different_paths(self, mock_read_csv, sample_dataframe):
        ...
        result1 = repo1.load_csv(sep=",")
        result2 = repo2.load_csv(sep=",")
